...
const secret = process.env.SECRET || "samentijdenscorona";
...
app.use("/stc/:id/comments", commentRoutes);

app.get("/", (req, res) => {
	res.render("stc/index");
});
...
// 	if (!err.message) err.message = "Oooooops hier gaat iets fout";
